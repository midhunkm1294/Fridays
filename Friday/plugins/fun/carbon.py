...
async def carbon_(message: Message):
    if Config.GOOGLE_CHROME_BIN is None:
        ...
        async with friday.conversation("CarbonNowShBot", timeout=30) as conv:
            try:
            ...
            await asyncio.gather(
                message.delete(),
                friday.send_document(chat_id=message.chat.id,
                                     document=file_id,
                                     caption='`' + caption + '`',
        ...
        if replied and (replied.text
            ...
            if replied.document:
                ...
                path_ = await friday.download_media(replied, file_name=Config.DOWN_PATH)
        ...
        await asyncio.gather(
            message.delete(),
            friday.send_photo(chat_id=message.chat.id,
                              photo=carbon_path,
