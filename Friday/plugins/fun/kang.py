...
from friday import friday, Message, Config, pool


@friday.on_cmd("kang", about={
...
async def kang_(message: Message):
    ...
    if replied and replied.media:
        ...
        photo = await friday.download_media(message=replied,
    ...
    if photo:
        ...
        if ("  A <strong>Telegram</strong> user has created "
            ...
            async with friday.conversation('Stickers') as conv:
                try:
...
async def sticker_pack_info_(message: Message):
    ...
    get_stickerset = await friday.send(
        GetStickerSet(
