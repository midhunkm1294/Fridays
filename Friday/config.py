...
if Config.LOAD_UNOFFICIAL_PLUGINS:
    ...
    os.system("git clone --depth=1 https://github.com/StarkGang/FridayPlugin.git")
    os.system("pip3 install -U pip")
    os.system("pip3 install -r Friday-plugins/requirements.txt")
    os.system("rm -rf Friday/plugins/unof_plugins/")
    os.system("mv Friday-Plugins/plugins/ friday/plugins/unof_plugins/")
    os.system("cp -r Friday-Plugins/resources/* resources/")
    os.system("rm -rf Friday-Plugins/")
